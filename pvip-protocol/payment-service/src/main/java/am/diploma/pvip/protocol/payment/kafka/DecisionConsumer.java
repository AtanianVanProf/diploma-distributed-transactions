...
import am.diploma.pvip.protocol.payment.event.GlobalDecisionEvent;
...
public class DecisionConsumer {
    ...
    @KafkaListener(topics = "pvip.decisions", groupId = "payment-service", containerFactory = "kafkaListenerContainerFactory")
